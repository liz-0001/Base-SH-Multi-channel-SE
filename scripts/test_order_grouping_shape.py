...
from networks.tfgridnetv2 import (
    AdjacentOrderInteraction,
...
def main():
    ...
    guidance = HighLowMutualGuidance(num_orders=len(order_features), hidden_dim=hidden_dim)
    guided_features = guidance(order_features)
